...
class FormPage extends Component {
  ...
  onSubmit = () => {
    ...
    db.collection("users")
      ...
      .then(this.props.history.push("/influencers/dashboard"))
      .catch(function () {
        ...
        <form>
          {active == 1 ? (
            ...
            <>
              <MDBContainer style={outerContainerStyle} className="my-5">
                <MDBScrollbar>
                  ...
                  <p>
                    ...
                    for the use of Influence Away's Website, located at
                    www.influenceaway.in.
                  </p>

                  <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use influenceaway.in if
                    you do not agree to take all of the terms and conditions
                    stated on this page. Our Terms and Conditions were created
                  ...
                  <p>
                    We employ the use of cookies. By accessing influenceaway.in,
                    you agreed to use cookies in agreement with the Influence
                    Away's Privacy Policy.
                  </p>
                  ...
                  <p>
                    Unless otherwise stated, Influence Away and/or its licensors
                    own the intellectual property rights for all material on
                    influenceaway.in. All intellectual property rights are
                    reserved. You may access this from influenceaway.in for your
                  ...
                  <p>
                    ...
                    the website. Influence Away does not filter, edit, publish
                    or review Comments prior to their presence on the website.
                    Comments do not reflect the views and opinions of Influence
                    Away,its agents and/or affiliates. Comments reflect the
                    views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws,
                    Influence Away shall not be liable for the Comments or for
                    any liability, damages or expenses caused and/or suffered as
                    a result of any use of and/or posting of and/or appearance
                    of the Comments on this website.
                  </p>

                  <p>
                    Influence Away reserves the right to monitor all Comments
                  ...
                  <p>
                    You hereby grant Influence Away a non-exclusive license to
                  ...
                  <p>
                    ...
                    compensates the absence of Influence Away; and (d) the link
                  ...
                  <p>
                    ...
                    inform us by sending an e-mail to Influence Away. Please
                  ...
                  <p>
                    No use of Influence Away's logo or other artwork will be
              ...
              <h2>By continuing you accept terms & conditions!</h2>
            </>
          )}
          <MDBRow between>
            <MDBBtn
