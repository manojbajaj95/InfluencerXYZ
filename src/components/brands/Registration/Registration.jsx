...
import { MDBContainer, MDBRow, MDBBtn, MDBInput, MDBScrollbar } from "mdbreact";
...
class FormPage extends Component {
  ...
  onSubmit = () => {
    alert("Thanks for registration. Our team will be in touch shortly");
    this.props.firebase.db
      .collection("users")
      .doc(this.props.authUser.uid)
      .set({
      ...
      .then(this.props.history.push("/brands/dashboard"))
      .catch(function () {
  ...
  render() {
    ...
    return (
      <MDBContainer className="mt-5 text-left">
        ...
        <form>
          <h3 className="text-center"> Brand Info </h3>
          <MDBInput
            label="Brand Name"
            icon="user-alt"
            ...
            id="name"
          />
          <h3 className="text-center"> Contact Person Info </h3>
          <MDBInput
            label="Name"
            icon="user-alt"
          ...
          <MDBContainer style={outerContainerStyle} className="my-5">
            <MDBScrollbar>
              <p>Welcome to Influenceaway.in!</p>

              <p>
                These terms and conditions outline the rules and regulations for
                the use of Influence Away's Website, located at
                www.influenceaway.in.
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use influenceaway.in if you do
              ...
              <p>
                We employ the use of cookies. By accessing influenceaway.in, you
                agreed to use cookies in agreement with the Influence Away's
                Privacy Policy.
              </p>
              ...
              <p>
                Unless otherwise stated, Influence Away and/or its licensors own
                the intellectual property rights for all material on
                influenceaway.in. All intellectual property rights are reserved.
                You may access this from influenceaway.in for your own personal
                use subjected to restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from influenceaway.in</li>
                <li>
                  Sell, rent or sub-license material from influenceaway.in
                </li>
                <li>
                  Reproduce, duplicate or copy material from influenceaway.in
                </li>
                <li>Redistribute content from influenceaway.in</li>
              </ul>
              ...
              <p>
                ...
                website. Influence Away does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Influence Away,its agents
                and/or affiliates. Comments reflect the views and opinions of
                the person who post their views and opinions. To the extent
                permitted by applicable laws, Influence Away shall not be liable
              ...
              <p>
                Influence Away reserves the right to monitor all Comments and to
              ...
              <p>
                You hereby grant Influence Away a non-exclusive license to use,
              ...
              <p>
                ...
                of Influence Away; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to Influence Away. Please include your
              ...
              <p>
                No use of Influence Away's logo or other artwork will be allowed
          ...
          <h3>By continuing you accept terms & conditions!</h3>
        </form>
      </MDBContainer>
    );
  }
